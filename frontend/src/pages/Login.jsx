...
function Login() {
  ...
  const handleGoogleLogin = () => {
    alert("Need to select an account");
  };

  return (
    <div className="min-h-screen flex flex-col md:flex-row items-center justify-center px-4 md:px-16  ${atTop ? 'mt-10' : 'mt-10'}">
      {/* Left Section */}
      ...
      <div className="md:w-1/2 w-full max-w-md bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-yellow-400 shadow-2xl">
        ...
        <div className="flex justify-center gap-6">
          <button className="bg-white/10 p-2 rounded-full border border-white/30 hover:scale-105 transition">
          ...
          <button onClick={handleGoogleLogin} className="bg-white/10 p-2 rounded-full border border-white/30 hover:scale-105 transition">
